		...
		class categoryEntity {
			...
			public function Delete(){
				...
				if(!empty($this->id_category)){
					...
					$sql = "DELETE FROM category WHERE id_category = ".intval($this->id_category).";";
			...
			public function Update(){
				...
				$sql = 'UPDATE `category` SET `id_category` = "'.$this->id_category.'", `title` = "'.$this->title.'" WHERE id_category = '.intval($this->id_category);
			...
			public function Insert(){
				...
				$sql = 'INSERT INTO category (`id_category`,`title`) VALUES ("'.$this->id_category.'","'.$this->title.'")';
			...
			public function findAll(){
				...
				foreach ($formatResult as $key => $data) {
					...
					$tmpInstance = new categoryEntity();
			...
			public function findOneBy($param,$value){
				...
				$sql =  'SELECT * FROM category WHERE '.$param.' = "'.$value.'"';
