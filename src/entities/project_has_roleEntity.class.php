<?php
		...
		class project_has_roleEntity {
					
			private $id_project;
			
			private $id_role;
			
            private $relations = array('role'=>array('id_role'=>'id_role'),'project'=>array('id_project'=>'id_project'),);
			...
			public function Delete(){
				...
				if(!empty($this->id_role)){
					...
					$sql = "DELETE FROM project_has_role WHERE id_role = ".intval($this->id_role).";";
			...
			public function Update(){
				...
				$sql = 'UPDATE `project_has_role` SET `id_project` = "'.$this->id_project.'", `id_role` = "'.$this->id_role.'" WHERE id_role = '.intval($this->id_role);
			...
			public function Insert(){
				...
				$sql = 'INSERT INTO project_has_role (`id_project`,`id_role`) VALUES ("'.$this->id_project.'","'.$this->id_role.'")';
			...
			public function findAll($recursif = 'yes'){
				...
				$sql = 'SELECT * FROM project_has_role';
				$result = TzSQL::getPDO()->prepare($sql);
				$result->execute();
				...
				foreach ($formatResult as $key => $data) {
					...
					$tmpInstance = new project_has_roleEntity();
			...
			public function findOneBy($param,$value){
				...
				$sql =  'SELECT * FROM project_has_role WHERE '.$param.' = "'.$value.'"';
			...
			public function find($id){
				...
				$sql = 'SELECT * FROM project_has_role WHERE id_role = ' . $id;
				$result = TzSQL::getPDO()->prepare($sql);
				$result->execute();
